...
info 'grails3x.constraints.typemismatch.test'

Environment.executeForCurrentEnvironment {
    development {
        debug 'grails3x.constraints.typemismatch.test'
        debug 'grails.app.controllers.grails3x.constraints.typemismatch.test'
